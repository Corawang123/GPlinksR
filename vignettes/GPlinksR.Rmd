...
For the executable examples below, we use a small deterministic subset of the
packaged data that is arranged to yield enhancer-, promoter-, and closest-based
links.
...
For this packaged example setup, the `SingleCellExperiment` wrapper also
returns the same example link table:
